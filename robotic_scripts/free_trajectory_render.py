...
def render_robot_free_trajectory():

    """
    This aims to render the robot in given trajectory and timestamp
    ...
    Args:
        ...
        output_filename: Name of the output file.
        rendered_output_names: List of outputs to visualise.
        timestamp: timestamp of the trajectory # should be same length as the trajectory(we define the data as a list of dict with (timestamp, pose))

    Returns:
        rendered_information of each (timestamp,pose) in the trajectory
...
def render_robot_camera_trajectory():
    '''
    This function aims to render the robotic arm build-in camera result and its trajectory that can be used in 
    vision-based policy training
    
    Args:
       intial_pose: initial pose of the camera in robotic arm
       trajectory: trajectory of gripper pose
       timestamp: timestamp of the trajectory # should be same length as the trajectory(we define the data as a list of dict with (timestamp, pose))
...
class RoboBaseRender:
    ...
    meta_sim_path: Path= Path("./Robostudio/dataset/config_info/push_bag.yaml")
    """Path to meta sim file."""
