...
# from nerfstudio.exporter.exporter_utils import Mesh, render_trajectory,render_trajectory_gs
...
#     color_images, depth_images = render_trajectory_gs(
#         pipeline,
#         cameras,
