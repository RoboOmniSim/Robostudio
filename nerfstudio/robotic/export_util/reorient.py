...
def reorient_point_cloud(input_mesh_path, output_mesh_path,re_orientation_matrix):
    """
    Args:
        input_mesh_path: path to the input mesh
        output_mesh_path: path to the output mesh
    ...
    point_cloud=o3d.io.read_point_cloud(input_mesh_path)

    sample_vertices=point_cloud.points
    ...
    point_cloud.points=o3d.utility.Vector3dVector(reseted_vertices)

    o3d.io.write_point_cloud(output_mesh_path, point_cloud)
    return point_cloud
