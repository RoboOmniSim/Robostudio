...
@dataclass
class NerfstudioDataParserbackwardConfig(DataParserConfig):
...
class Nerfstudio(DataParser):
    ...
    config: NerfstudioDataParserbackwardConfig
    downscale_factor: Optional[int] = None
    ...
    def _generate_dataparser_outputs(self, split="train"):
        ...
        if self.config.load_3D_points:
            ...
            # if "ply_file_path" in meta:
            if True:
                ply_file_path = Path('/home/lou/Downloads/static_all/result_ns/splat_scene.ply')
            ...
            if ply_file_path:
                sparse_points = self._load_3D_points(ply_file_path, transform_matrix, scale_factor)  # the scale factor of the transition , transform_matrix also need this 

                print('sparse_points:', sparse_points['points3D_xyz'].shape)
